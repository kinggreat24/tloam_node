...
protected:
  ...
  void onSaveLidarOdometryPoseCb(const std_msgs::String::ConstPtr& msg);
private:
  // subscriber
  ...
  //激光里程计轨迹相关
  ros::Subscriber pose_save_sub_;
  ros::Publisher lidar_path_pub_;
  Eigen::Matrix4d T_velodyne2cam = Eigen::Matrix4d::Identity();
  std::vector<Eigen::Isometry3d> lidar_pose_vec;
};
}
